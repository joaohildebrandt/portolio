...
import { careers, companiesImages, educations, menuLinks } from "~/data";
							...
							<div className="flex flex-col gap-32">
								<div>
									<h1 className="scroll-m-20 text-4xl font-extrabold tracking-wide lg:text-5xl text-center mb-8">
										Hello! <br />I am{" "}
										<span className="text-transparent bg-clip-text bg-linear-to-r from-purple-600 to-blue-400">
											João Paulo
										</span>
				...
				<section className="pt-16 mt-8 min-h-screen" id="about">
					...
					<div className="col-span-12 flex flex-col">
						<h1 className="scroll-m-20 text-4xl font-extrabold lg:text-5xl mb-4">
							Bring your{" "}
							<span className="text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-purple-400">
								vision
							</span>{" "}
							to{" "}
					...
					<div className="mt-16 md:mt-32 ">
						<p className="text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-purple-400 text-2xl font-bold text-center mb-4">
